...
$C\_{23b} = b\_{o}$ is the largest constant for which one has an inequality
$$ L \geq b_{o} C $$
...
- Non-alternating knots have a three-quarter power lower bound, discussed in [23a](https://teorth.github.io/optimizationproblems/constants/23a.html).
