...
$C_{22b} = a$ is the infimal area of a convex planar set $\Omega$ that can cover a congruent copy of every convex planar set of diameter $1$.
...
- See also: [Moser’s worm problem](https://teorth.github.io/optimizationproblems/constants/22a.html).
