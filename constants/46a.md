...
| $\infty$ | Trivial | |
| $6$ | Stein (1967) |
| $4$ | [Tom1975], [Stein1993] | From the Stein--Tomas theorem |
| $4-\frac{2}{15} \approx 3.86667$ | [Bo1991] | |
| $4-\frac{2}{11} \approx 3.81818$ | [Wo1995], [MVV1996] |  |
| $4-\frac{2}{9} \approx 3.77778$ | [TVV1998] |  |
| $4-\frac{2}{7} \approx 3.71429$ | [TV2000] |  |
| $\frac{10}{3}\approx 3.33333$ | [Tao2003] |
...
| Bound | Reference | Comments |
| ---: | :--- | :--- |
| $3$ | Stationary phase / explicit computation | Take $f=1$.  Conjectured to be sharp by Stein in the 1970s. |


## Further remarks

- **Sphere vs. paraboloid.** Many papers work with the paraboloid model surface; by localization and rescaling, the best-known exponents for compact strictly convex surfaces (including $S^2$) track the paraboloid results up to standard $\varepsilon$-losses that can often be removed by "epsilon removal lemmas".

- **Relation to the \(L^p\to L^p\) restriction conjecture.** A stronger conjecture (also attributed to Stein) asks for $$ \|\widehat{fd\sigma}\|_{L^p(\mathbb{R}^3)} \lesssim_p \|f\|_{L^p(S)}
  \qquad\text{for all }p>3 $$
whenever $S\subset\mathbb{R}^3$ is a smooth compact surface with strictly positive second fundamental form. Any such $L^p\to L^p$ estimate automatically implies the $L^\infty\to L^p$ estimate defining $C_{46}$ by Holder's inequality.
